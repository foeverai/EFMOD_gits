...
class DepthMetric(BaseMetric):
    ...
    Args:
        ...
        crop_type (str, optional): Specifies the type of cropping to be used
            during evaluation. This option can affect how the evaluation ann_dir
    ...
    def _get_eval_mask(self, gt_depth: Tensor):
        """Generates an evaluation ann_dir based on ground truth depth and
        cropping.
        ...
        Returns:
            Tensor: Boolean ann_dir where evaluation should be performed.
        """
