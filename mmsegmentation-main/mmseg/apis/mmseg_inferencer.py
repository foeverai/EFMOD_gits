...
class MMSegInferencer(BaseInferencer):
    ...
    def __init__(self,
        ...
        # A global counter tracking the number of img_dir processes, for
        # naming of the output img_dir
    ...
    def __call__(self,
        ...
        Args:
            ...
            show (bool): Whether to display the rendering color segmentation
                ann_dir in a popup window. Defaults to False.
            wait_time (float): The interval of show (s). Defaults to 0.
            out_dir (str): Output directory of inference results. Defaults
                to ''.
            img_out_dir (str): Subdirectory of `out_dir`, used to save
                rendering color segmentation ann_dir, so `out_dir` must be defined
                if you would like to save predicted ann_dir. Defaults to 'vis'.
            pred_out_dir (str): Subdirectory of `out_dir`, used to save
                predicted ann_dir file, so `out_dir` must be defined if you would
                like to save predicted ann_dir. Defaults to 'pred'.
    ...
    def visualize(self,
        ...
        Args:
            ...
            img_out_dir (str): Output directory of rendering prediction i.e.
                color segmentation ann_dir. Defaults: ''
            opacity (int, float): The transparency of segmentation ann_dir.
                Defaults to 0.8.
    ...
    def postprocess(self,
        ...
        Returns:
            ...
            - ``predictions`` (List[np.ndarray], np.ndarray): Returned by
              ...
              If ``return_datasample=False``, it will be the segmentation ann_dir
              with label indice.
        """
