...
def binary_cross_entropy(pred,
    ...
    if pred.size(1) == 1:
        ...
        # binary class label check should ann_dir out
        # ignore_index
    ...
    if pred.dim() != label.dim():
        ...
        # should ann_dir out the ignored elements
...
def mask_cross_entropy(pred,
    ...
    Args:
        ...
        label (torch.Tensor): ``label`` indicates the class label of the ann_dir'
            corresponding object. This will be used to select the ann_dir in the
            of the class which the object belongs to when the ann_dir prediction
...
class CrossEntropyLoss(nn.Module):
    ...
    Args:
        ...
        use_mask (bool, optional): Whether to use ann_dir cross entropy loss.
            Defaults to False.
