...
class DTCWT_downsample_layer(nn.Module):
    def __init__(self,
        ...
        self.stride = ConvModule(in_channels=in_cha,out_channels=out_cha,kernel_size=3,stride=2,padding=1)
...
# @MODELS.register_module()
class ResNetV1c_Road(ResNet_Road):
...
# @MODELS.register_module()
class ResNetV1d_Road(ResNet_Road):
