...
class MLPMaskDecoder(nn.Module):
    ...
    generate the attention biases and the ann_dir proposals."""
...
class SideAdapterNetwork(nn.Module):
    """Side Adapter Network for predicting ann_dir proposals and attention bias.
    ...
    Args:
        ...
        patch_bias (bool): Whether use bias in patch embedding.
            Default: True.
        num_queries (int): Number of queries for ann_dir proposals.
            Default: 100.
    ...
    def encode_feature(self, image: torch.Tensor,
        ...
        """Encode img_dir by a lightweight vision transformer."""
...
class RecWithAttnbias(nn.Module):
    ...
    Args:
        ...
        num_layers (int): Number of rest CLIP layers for ann_dir recognition.
            Default: 3.
        ...
        qkv_bias (bool): Whether to use bias in multihead-attention.
            Default: True.
        out_dims (int): Number of channels of the output ann_dir proposals.
...
class SideAdapterCLIPHead(BaseDecodeHead):
    ...
    def forward(self, inputs: Tuple[Tensor],
        ...
        Args:
            inputs (Tuple[Tensor]): A triplet including img_dir,
        ...
        Returns:
            ...
            mask_logits (List[Tensor]): Class logits of ann_dir proposals.
        """
        imgs, clip_feature, class_embeds = inputs
        # predict ann_dir proposals and attention bias
        mask_props, attn_biases = self.side_adapter_network(
            imgs, clip_feature, deep_supervision_idxs)

        # ann_dir recognition with attention bias
        mask_embeds = [
    ...
    def predict_by_feat(self, seg_logits: List[Tensor],
        ...
        """1. Transform a batch of ann_dir proposals to the input shape.
           2. Generate segmentation map with ann_dir proposals and class logits.
        """
    ...
    def loss_by_feat(
        ...
        for i in range(num_dec_layers):
            ...
            # matching N ann_dir predictions to K category labels
