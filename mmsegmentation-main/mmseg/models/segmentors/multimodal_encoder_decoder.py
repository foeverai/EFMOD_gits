...
class MultimodalEncoderDecoder(BaseSegmentor):
    ...
    Args:
        ...
        encoder_resolution (float): resize scale of input img_dir for image encoder.
            Defaults to None.
    ...
    def extract_feat(self, inputs: Tensor) -> List[Tensor]:
        """Extract visual features from img_dir."""
        x = self.image_encoder(inputs)
        return x

    def encode_decode(self, inputs: Tensor,
                      batch_img_metas: List[dict]) -> Tensor:
        """Encode the name of classes with text_encoder and encode img_dir with
        image_encoder.
    ...
    def predict(self,
        ...
        Returns:
            ...
            input img_dir. Each SegDataSample usually contain:
    ...
    def slide_inference(self, inputs: Tensor,
        ...
        Args:
            inputs (tensor): the tensor should have a shape NxCxHxW,
                which contains all img_dir in the batch.
    ...
    def whole_inference(self, inputs: Tensor,
        ...
        Args:
            inputs (Tensor): The tensor should have a shape NxCxHxW, which
                contains all img_dir in the batch.
            batch_img_metas (List[dict]): List of image metainfo where each may
                also contain: 'img_shape', 'scale_factor', 'flip', 'img_path',
                'ori_shape', and 'pad_shape'.
                For details on the values of these keys see
