...
def cross_attn_with_self_bias(
    ...
    Args:
        ...
        key_padding_mask: if provided, specified padding elements in the key will
            be ignored by the attention. This is an binary ann_dir. When the value is True,
        ...
        attn_mask: 2D ann_dir that prevents attention to certain positions. A 2D ann_dir will be broadcasted for all
            the batches while a 3D ann_dir allows to specify a different ann_dir for the entries of each batch.
