...
def deepglobe1024_classes():
    return ['background', 'road']


def massachusettsroad_classes():
    return ['background', 'road']
...
def deepglobe1024_palette():
    return [[120, 120, 120], [6, 230, 230]]


def massachusettsroad_palette():
    return [[120, 120, 120], [6, 230, 230]]
...
dataset_aliases = {
    ...
    'isaid': ['isaid', 'iSAID'],
    'stare': ['stare', 'STARE'],
    'deepglobe1024': ['deepglobe1024','Deepglobe1024'],
    'massachusetts':['massachusettsroad','MassachusettsRoad'],
    'chn6cug':['chn6cug','CHN6CUG'],
    'map':['map','MAP'],
    'lip': ['LIP', 'lip'],
