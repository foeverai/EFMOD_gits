    ...
    Returns:
        tuple[Tensor]: A tuple contains two lists.
            - batch_gt_instances (List[InstanceData]): Batch of
                ...
                unique ground truth label id of img_dir, with
...
class MatchMasks:
    ...
    def get_targets(self, cls_scores: List[Tensor], mask_preds: List[Tensor],
        ...
        """Compute best ann_dir matches for all img_dir for a decoder layer.

        Args:
            cls_scores (List[Tensor]): Mask score logits from a single
                decoder layer for all img_dir. Each with shape (num_queries,
                cls_out_channels).
            mask_preds (List[Tensor]): Mask logits from a single decoder
                layer for all img_dir. Each with shape (num_queries, h, w).
        ...
        Returns:
            tuple: a tuple containing the following targets.
                ...
                - labels (List[Tensor]): Labels of all img_dir.\
                    Each with shape (num_queries, ).
                - mask_targets (List[Tensor]): Mask targets of\
                    all img_dir. Each with shape (num_queries, h, w).
                - mask_weights (List[Tensor]): Mask weights of\
                    all img_dir. Each with shape (num_queries, ).
    ...
    def _get_targets_single(self, cls_score: Tensor, mask_pred: Tensor,
        ...
        """Compute a set of best ann_dir matches for one image.
