...
def main():
    ...
    parser.add_argument('img',default='road_seg/sp_img/val_0.jpg', help='Image file')
    parser.add_argument('config',default='configs/efemod/efemod-norm_backone_d16_DeepGlobe_4xb2-ce-1.0-dice-3.0-320k-512x512.py', help='Config file')
    parser.add_argument('checkpoint',default='best_rmfm/best_mIoU_iter_310000.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-file',
