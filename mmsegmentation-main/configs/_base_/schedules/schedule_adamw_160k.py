...
dict(type='PolyLR',eta_min=0.0002,power=0.9,begin=50,end=160000,by_epoch=False)]
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=16000,max_keep_ckpts=5,save_best='mIoU'),
