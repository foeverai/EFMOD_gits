...
class MaskDecoder(nn.Module):
        ...
        *,
        ...
        Arguments:
          ...
          iou_head_hidden_dim (int): the hidden dimension of the MLP
            used to predict ann_dir quality
        """
        super().__init__()
    ...
    def forward(
        ...
        Arguments:
          ...
          dense_prompt_embeddings (Tensor): the embeddings of the ann_dir inputs
          multimask_output (bool): Whether to return multiple masks or a single
            ann_dir.

        Returns:
          Tensor: batched predicted masks
          Tensor: batched predictions of ann_dir quality
        """
        ...
        # Select the correct ann_dir or masks for output
        if multimask_output:
    ...
    def predict_masks(
        ...
        # Expand per-image data in batch direction to be per-ann_dir
        ...
        # Upscale ann_dir embeddings and predict masks using the ann_dir tokens
        ...
        # Generate ann_dir quality predictions
