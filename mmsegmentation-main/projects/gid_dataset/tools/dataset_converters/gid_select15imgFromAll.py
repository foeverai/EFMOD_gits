...
# select 15 img_dir from GID dataset
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='From 150 img_dir of GID dataset to select 15 img_dir')
    parser.add_argument('dataset_img_dir', help='150 GID img_dir folder path')
    parser.add_argument('dataset_label_dir', help='150 GID labels folder path')

    parser.add_argument('dest_img_dir', help='15 GID img_dir folder path')
...
def main():
    """This script is used to select 15 img_dir from GID dataset, According to
    ...
    # copy img_dir of 'img_list' to 'desr_dir'
    print('Copy img_dir of img_list to desr_dir ing...')
    for img in img_list:
