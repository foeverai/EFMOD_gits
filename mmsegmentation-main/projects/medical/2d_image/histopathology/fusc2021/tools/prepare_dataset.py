...
src_img_train_dir = os.path.join(
    ...
    'Foot Ulcer Segmentation Challenge/train/img_dir')
src_img_val_dir = os.path.join(
    root_path, 'wound-segmentation/data/' +
    'Foot Ulcer Segmentation Challenge/validation/img_dir')
src_img_test_dir = os.path.join(
    root_path, 'wound-segmentation/data/' +
    'Foot Ulcer Segmentation Challenge/test/img_dir')
...
tgt_img_train_dir = os.path.join(root_path, 'img_dir/train/')
tgt_mask_train_dir = os.path.join(root_path, 'masks/train/')
tgt_img_val_dir = os.path.join(root_path, 'img_dir/val/')
tgt_mask_val_dir = os.path.join(root_path, 'masks/val/')
tgt_img_test_dir = os.path.join(root_path, 'img_dir/test/')
