...
tgt_img_dir = os.path.join(root_path, 'img_dir/train')
...
fold_img_paths = sorted([
    os.path.join(root_path, 'pannuke/Fold 1/img_dir/fold1/img_dir.npy'),
    os.path.join(root_path, 'pannuke/Fold 2/img_dir/fold2/img_dir.npy'),
    os.path.join(root_path, 'pannuke/Fold 3/img_dir/fold3/img_dir.npy')
])
