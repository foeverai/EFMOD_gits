...
def parse_args():
    ...
    parser.add_argument('dataset_img_path', help='GID img_dir folder path')
    ...
    parser.add_argument(
        '--stride_size',
        type=int,
        help='stride of clipping original img_dir',
        default=256)
...
def clip_big_image(image_path, clip_save_dir, args, to_label=False):
    ...
    256 and stride size is 256, thus it would generate 29 x 27 = 783 img_dir
...
def main():
    ...
    select 15 img_dir contained in GID, , which cover the whole six
...
class GID_Dataset(BaseSegDataset):
    ...
    In This example, select 10 img_dir from GID dataset as training set,
    and select 5 img_dir as validation set.
    The selected img_dir are listed as follows:
