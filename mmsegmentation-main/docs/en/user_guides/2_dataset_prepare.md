...
# unzip
unzip train2017.zip -d img_dir/
unzip val2017.zip -d img_dir/
...
```shell
python tools/dataset_converters/stare.py /path/to/stare-img_dir.tar /path/to/labels-ah.tar /path/to/labels-vk.tar
```
